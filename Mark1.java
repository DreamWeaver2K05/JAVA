...
class Mark1 extends JFrame implements ActionListener {
    TreeSet<Student> t;
    ...
    Mark1() {
        ...
        ta = new JTextArea(5, 20);  // Initializing correctly
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                ...
                Student student = new Student(reg, name, m1, m2, m3);
                t.add(student);
                ta.setText("Student added with CGPA: " + student.cgpa);
            ...
            try {
                int reg = Integer.parseInt(t6.getText());
                boolean found = false;
                for (Student student : t) {
                    if (reg == student.reg) {
                        ta2.setText(student.toString());
                        found = true;
                        break;
                    }
                }
                ...
                ta2.setText("Invalid registration number format.");
            } catch (Exception1 e) {
